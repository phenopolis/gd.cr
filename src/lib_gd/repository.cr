...
lib LibGD
  ...
  fun image_create_from_gd = gdImageCreateFrom(in : File*) : ImagePtr
  fun image_create_from_gd2 = gdImageCreateFrom2(in : File*) : ImagePtr
  fun image_create_from_gd2_ctx = gdImageCreateFrom2Ctx(in : IoCtxPtr) : ImagePtr
  fun image_create_from_gd2_part = gdImageCreateFrom2Part(in : File*, srcx : LibC::Int, srcy : LibC::Int, w : LibC::Int, h : LibC::Int) : ImagePtr
  fun image_create_from_gd2_part_ctx = gdImageCreateFrom2PartCtx(in : IoCtxPtr, srcx : LibC::Int, srcy : LibC::Int, w : LibC::Int, h : LibC::Int) : ImagePtr
  fun image_create_from_gd2_part_ptr = gdImageCreateFrom2PartPtr(size : LibC::Int, data : Void*, srcx : LibC::Int, srcy : LibC::Int, w : LibC::Int, h : LibC::Int) : ImagePtr
  fun image_create_from_gd2_ptr = gdImageCreateFrom2Ptr(size : LibC::Int, data : Void*) : ImagePtr
  ...
  fun image_gd = gdImage(im : ImagePtr, out : File*)
  fun image_gd2 = gdImage2(im : ImagePtr, out : File*, cs : LibC::Int, fmt : LibC::Int)
  fun image_gd2_ptr = gdImage2Ptr(im : ImagePtr, cs : LibC::Int, fmt : LibC::Int, size : LibC::Int*) : LibC::Char*
